	...
	override public function create()
	{
			...
			case 'street1':
				{
					defaultCamZoom = 0.8;
					curStage = 'street1';
					var bg:FlxSprite = new FlxSprite(-618.15, 110.15).loadGraphic(Paths.image('bg', 'muse'));
					bg.antialiasing = true;
		...
		switch (curStage)
		{
			...
			case 'schoolEvil':
				...
				gf.y += 300;
			case 'street1':
				boyfriend.setPosition(987.50, 858.05);
				gf.setPosition(319.70, 568.85);
		}
	...
	private function generateStaticArrows(player:Int):Void
	{
		for (i in 0...4)
		{
			...
			switch (noteTypeCheck)
			{
				...
				case 'normal':
					if (player == 0)
						babyArrow.frames = Paths.getSparrowAtlas('NOTE_muse', 'muse');
					else if (player == 2) 
						babyArrow.frames = Paths.getSparrowAtlas('NOTE_muse', 'muse');
					else 

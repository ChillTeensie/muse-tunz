...
class Credits extends MusicBeatState
{
	...
	override function update(elapsed:Float)
	{
		...
		if (accepted)
		{
			...
			{
				case 'Jorclai':
							//fancyOpenURL("https://twitter.com/OfficialJorclai");
					fancyOpenURL("https://www.youtube.com/channel/UCN3DHACbTcHPSss6CIwcg3w");
				case 'Gosh':
					fancyOpenURL('https://twitter.com/aka_goshhhh');
				case 'Lone Drifter':
					fancyOpenURL('https://twitter.com/LoneDrifter8');
				case 'Knivez':
					fancyOpenURL('https://twitter.com/knivesprites');
				case 'ChillTeensie':
					fancyOpenURL("https://www.youtube.com/channel/UCHEksUNrZ_wk7WnpVy0ghYQ");
				case 'Person':
					fancyOpenURL('https://www.youtube.com/channel/UCmAI7f48iRxkG2RuFRwL9TQ');
				case 'Maka Aikawa':
					fancyOpenURL('https://www.twitch.tv/makaaikawa');
